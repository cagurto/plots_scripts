...
plt.plot(datam['lambda'],datam['kappa_q_3_0_porous'],color='r',label='$Porous \ q=3.0$')
plt.plot(datam['lambda'],datam['kappa_q_3_5_porous'],color='r',linestyle='--',label='$Porous \ q=3.5$')
plt.plot(datam['lambda'],datam['kappa_q_3_0_compact'],color='b',label='$Compact \ q=3.0$')
plt.plot(datam['lambda'],datam['kappa_q_3_5_compact'],color='b',linestyle='--',label='$Compact \ q=3.5$')
